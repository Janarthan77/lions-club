  ...
  return (
    <header 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        isScrolled 
          ? 'py-3 bg-white/90 shadow-xl shadow-slate-900/5 border-b border-amber-500/30 backdrop-blur-xl' 
          : 'py-5 bg-white/80 border-b border-slate-200/80 backdrop-blur-md'
      }`}
    >
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white/98 border-b border-amber-500/30 px-4 py-5 space-y-3 shadow-2xl backdrop-blur-xl animate-fadeIn">
